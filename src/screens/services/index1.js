...
const ServicesExample = ({navigation}) => {
            ...
            <ScrollView>
                <View style={styles.maincontainer}>
                        ...
                        <View style={styles.eigthview}>
                            <View style={styles.ninthview}>
                                ...
                                <TouchableOpacity onPress={() => isVisible != 1 ? setIsVisible(1) : setIsVisible(0)}>
                                    <Image source={Logo} style={[styles.img4, { transform: isVisible != 1 ? [{ rotate: '360deg' }] : [{ rotate: '180deg' }] }]} />
                    ...
                    <View style={styles.seventhview}>
                        ...
                        <View style={styles.eigthview}>
                            <View style={styles.ninthview}>
                                ...
                                <TouchableOpacity onPress={()=> isVisible !=2? setIsVisible(2):setIsVisible(0)}>
                                    <Image source={Logo} style={[styles.img4,{transform:isVisible !=2? [{rotate:'360deg'}]:[{rotate:'180deg'}]}]} />
                        ...
                        {isVisible ==2  && (<Text style={styles.txt3}> Jorem ipsum dolor sit amet, consectetur adipiscing elit.{'\n'} Etiam eu turpis molestie, dictum est a, mattis tellus. Sed{'\n'} dignissim, metus nec fringilla accumsan, risus sem {'\n'} sollicitudin lacus, ut interdum tellus elit sed risus.Maecenas {'\n'} eget condimentum velit, sit amet feugiat lectus.aptent taciti{'\n'} sociosqu ad litora torquent</Text>)}
                    ...
                    <View style={styles.seventhview}>
                        ...
                        {isVisible==3 && (<Text style={styles.txt3}> Jorem ipsum dolor sit amet, consectetur adipiscing elit.{'\n'} Etiam eu turpis molestie, dictum est a, mattis tellus. Sed{'\n'} dignissim, metus nec fringilla accumsan, risus sem {'\n'} sollicitudin lacus, ut interdum tellus elit sed risus.Maecenas {'\n'} eget condimentum velit, sit amet feugiat lectus.aptent taciti{'\n'} sociosqu ad litora torquent</Text>)}
                    ...
                    <View style={styles.seventhview}>
                        ...
                        {isVisible==4 && (<Text style={styles.txt3}> Jorem ipsum dolor sit amet, consectetur adipiscing elit.{'\n'} Etiam eu turpis molestie, dictum est a, mattis tellus. Sed{'\n'} dignissim, metus nec fringilla accumsan, risus sem {'\n'} sollicitudin lacus, ut interdum tellus elit sed risus.Maecenas {'\n'} eget condimentum velit, sit amet feugiat lectus.aptent taciti{'\n'} sociosqu ad litora torquent</Text>)}
