      ...
      <View >
            ...
            <View style={styles.container}>
                ...
                <View style={styles.secondview}>
                    <Text style={styles.txt}>How To</Text>
                </View>
            ...
            <View style={styles.frequencyview}>
                <Text style={styles.FRQtxt}>How to use{'\n'}each service</Text>

            </View>
            <View style={styles.MAINVIEW}>
                <View style={styles.BOTMVIEW}>
                    <View style={styles.DOWNVIEW}>
                        <Text style={styles.txt1}>1. How to use Teledoc?</Text>
            ...
            <View style={styles.MAINSECVIEW}>
                <View style={styles.BOTMVIEW}>
                    <View style={styles.DOWNVIEW}>
                        <Text style={styles.txt1}>2. How to use Dirx?</Text>
            ...
            <View style={styles.MAINSECVIEW}>
                <View style={styles.BOTMVIEW}>
                    <View style={styles.DOWNVIEW}>
                        <Text style={styles.txt1}>3. How to use Textcoach?</Text>
            ...
            <View style={styles.MAINSECVIEW}>
                <View style={styles.BOTMVIEW}>
                    <View style={styles.DOWNVIEW}>
                        <Text style={styles.txt1}>4. How to use Quest Health?</Text>
